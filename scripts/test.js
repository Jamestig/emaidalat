...
*/
	...
	if (window.matchMedia('(min-width: 1280px)').matches) {
		...
		if (current_href === 'http://localhost/local_wordpress/' || current_href === 'http://localhost/local_wordpress/our-story/' || current_href === 'http://localhost/local_wordpress/our-rooms/') {
