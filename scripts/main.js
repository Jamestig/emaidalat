document.addEventListener('DOMContentLoaded', function () {
	...
	*/
	...
	jQuery('.openHours').on('click', function () {
		jQuery('.hours-overlay').fadeIn();
	});

	jQuery('.closeButton').on('click', function () {
		jQuery('.hours-overlay').fadeOut();
	});
