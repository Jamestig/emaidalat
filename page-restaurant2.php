<?php
/*
Template Name: Dynamic Restaurant Page
 */
...
<?php get_template_part('template-parts/menus-navigation' ); ?>
		...
		<section class="menu__course">
			...
			<section class="menuSection menu__sub-course">
				...
				$posts = get_posts(array(
						'meta_query' => array(
								array(
										'key' => 'section', // name of custom field
										'value' => '"appetiser"', // matches exactly "appetiser"
										'compare' => 'LIKE'
								)
						)
				));
		...
		<nav class="menus__nav menus__nav-bottom">
			<ul class="menu__list">
