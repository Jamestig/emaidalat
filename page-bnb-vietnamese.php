	...
	<section class="fp-section pageSection" data-anchor="bnb-intro">
		...
		<div class="ribbon-container">
			<div class="content">
				...
				<p>Giá phòng ở émai bao gồm bữa ăn sáng phong phú và ngon miệng do đầu bếp thật giỏi sửa soạn.</p>
...
-->
	...
	<section class="fp-section pageSection section-room rooms-lila" data-anchor="rooms-lila">
		...
		<div class="center flex-container-room">
			...
			<div class="room-description">
			<p>Phòng áp mái của émai nằm nép mình dưới trần nhà bằng gỗ có gắn khung cửa sổ nhỏ. Lấy cảm hứng từ kiến trúc Nhật Bản, émai sử dụng tấm đệm dày trải trên sàn gỗ tạo thành chỗ nghỉ ngơi êm ái và ấm áp cho bạn.</p>
			</div>
